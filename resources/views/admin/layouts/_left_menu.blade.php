<ul id="menu" class="page-sidebar-menu">
    ...
    <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
        <a href="#">
            ...
            <span class="title">مدیریت مشریان</span>
        </a>
    </li>
    <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
        <a href="#">
            <i class="livicon" data-name="briefcase" data-size="18" data-c="#6CC66C" data-hc="#6CC66C"
                data-loop="true"></i>
            <span class="title">مدیریت درخواست ها</span>
    ...
    <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
        <a href="#">
            <i class="livicon" data-name="tablet" data-size="18" data-c="#6CC66C" data-hc="#6CC66C"
                data-loop="true"></i>
            <span class="title">مدیریت دسترسی ها</span>
        </a>
    </li>
    <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
        <a href="#">
            <i class="livicon" data-name="tablet" data-size="18" data-c="#6CC66C" data-hc="#6CC66C"
                data-loop="true"></i>
            <span class="title">مدیریت تراکنش ها</span>
            <span class="fa arrow"></span>
        </a>
        <ul class="sub-menu">
            <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
    ...
    <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
        <a href="#">
            <i class="livicon" data-name="tablet" data-size="18" data-c="#6CC66C" data-hc="#6CC66C"
                data-loop="true"></i>
            <span class="title">مدیریت کارت ها</span>
        </a>
    </li>
    <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
        <a href="#">
    ...
    <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
        <a href="#">
            <i class="livicon" data-name="tablet" data-size="18" data-c="#6CC66C" data-hc="#6CC66C"
                data-loop="true"></i>
            <span class="title">مدیریت کیف پول ها</span>
        </a>
    </li>
    <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
        <a href="#">
    ...
    <li {!! (Request::is('') ? 'class="active"' : '' ) !!}>
        <a href="#">
            <i class="livicon" data-name="tablet" data-size="18" data-c="#6CC66C" data-hc="#6CC66C"
                data-loop="true"></i>
            <span class="title">معرفی دوستان</span>
        </a>
    </li>
