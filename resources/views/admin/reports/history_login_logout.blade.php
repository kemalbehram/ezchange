...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>گزارشات</li>
            <li class="active">تاریخچه ورود و خروج</li>
        </ol>
    </section>
                    ...
                    <div class="card-body">
                        <div class="table-responsive-lg table-responsive-sm table-responsive-md">
                            <table class="table table-bordered width100" id="table">
                                <thead>
                                <tr class="filters">
                                    <th>@lang('reports/title.user_profile')</th>
                                    <th>@lang('reports/title.first_name')</th>
                                    <th>@lang('reports/title.last_name')</th>
                                    <th>@lang('reports/title.email')</th>
                                    <th>@lang('reports/title.id')</th>
                                    <th>@lang('reports/title.date')</th>
                                    <th>@lang('reports/title.time')</th>
                                    <th>@lang('reports/title.title')</th>
